...
typedef struct
{
    ...
    velocity_t gx; ///< Horizontal velocity (-255 to +255) in 'sand space' aka gravity
    velocity_t gy; ///< Vertical velocity (-255 to +255) in 'sand space' aka gravity
    velocity_t vx; ///< Horizontal velocity (-255 to +255) in 'sand space' aka gravity
    velocity_t vy; ///< Vertical velocity (-255 to +255) in 'sand space' aka gravity
} Grain;

typedef struct
{
    dimension_t x = 0; ///< Horizontal position in 'sand space'
    dimension_t y = 0; ///< Vertical position in 'sand space'
} SolidObject;
...
public:
    ...
    */
    ...
    bool generate_solid_object(int num_solid_pixels);
    bool setSolidObject(int n, dimension_t x, dimension_t y);
    ...
    */
    ...
    void setPixelSolidObject(dimension_t x, dimension_t y);
    void clearPixelSolidObject(dimension_t x, dimension_t y);
    bool getPixelSolidObject(dimension_t x, dimension_t y);
    void getPositionSolidObject(int i, dimension_t *x, dimension_t *y);
    /*!
    ...
    */
    ...
    /*!
        ...
        @return true if spot occupied by a grain or obstacle,
                otherwise false.
    */
    bool getPixel(dimension_t x, dimension_t y);
